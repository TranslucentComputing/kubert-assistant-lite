...
[![Azure home](/assets/images/azure-vm/1_azure-home.png)](/assets/images/azure-vm/1_azure-home.png)

## Step 2: Create a Virtual Machine

1. Navigate to the "Virtual Machine" section in the Azure Portal.
    [![Azure VM Home](/assets/images/azure-vm/2_azure-vm-home.png)](/assets/images/azure-vm/2_azure-vm-home.png)
2. Click "Create" and select "Azure virtual machine".
    [![Create VM](/assets/images/azure-vm/3_create-vm.png)](/assets/images/azure-vm/3_create-vm.png)

## Step 3: Configure the VM

1. Start by creating a new, click "Create a resource".
    [![Create Resource](/assets/images/azure-vm/4_create-resource-group.png)](/assets/images/azure-vm/4_create-resource-group.png)
...
2. Enter the host name and choose the region where you want to deploy the VM.
    [![Host Name](/assets/images/azure-vm/5_define_host_name.png)](/assets/images/azure-vm/5_define_host_name.png)
3. Select image and security type.
    [![Image Name](/assets/images/azure-vm/6_security_and_image.png)](/assets/images/azure-vm/6_security_and_image.png)
...
4. Select the size.
   [![VM size selection for CPU and RAM](/assets/images/azure-vm/7_size_cpu_ram.png)](/assets/images/azure-vm/7_size_cpu_ram.png)
...
5. Account and inbound ports.
   [![Account credentials and inbound port configuration](/assets/images/azure-vm/8_account_port.png)](/assets/images/azure-vm/8_account_port.png)
...
6. Disks
   [![Disk configuration settings](/assets/images/azure-vm/9_disks.png)](/assets/images/azure-vm/9_disks.png)

   `Note`-> No updates are required in this section, click on the "Next: Networking >" to continue the configuration.
7. Networking
   [![Networking settings with delete public IP option](/assets/images/azure-vm/10_delete_public_ip.png)](/assets/images/azure-vm/10_delete_public_ip.png)
...
8. Auto-shutdown
   [![Auto Shutdown](/assets/images/azure-vm/11_auto-shutdown.png)](/assets/images/azure-vm/11_auto-shutdown.png)
...
9. Trigger deployment.
   [![Start VM creation](/assets/images/azure-vm/12_create-vm.png)](/assets/images/azure-vm/12_create-vm.png.png)

   `Note`-> Review the configuration and click "Create" to start the deployment.
10. Deploying
   [![Deploying](/assets/images/azure-vm/13_deploying.png)](/assets/images/azure-vm/13_deploying.png)
11. Deployment completed, go to the resource.
   [![Deployed](/assets/images/azure-vm/14_done-deployment.png)](/assets/images/azure-vm/14_done-deployment.png)
12. Deployed host
   [![Host](/assets/images/azure-vm/15_host.png)](/assets/images/azure-vm/15_host.png)
13. Set RDP port
   [![Set RDP Port](/assets/images/azure-vm/16_set-rdp-port.png)](/assets/images/azure-vm/16_set-rdp-port.png)

    `Note`-> Go to the "Operations" section, then "Run command", select the "SetRDPPort"
14. Enter the RDP port and execute the script.
   [![Enter RDP Port](/assets/images/azure-vm/17_enter-port.png)](/assets/images/azure-vm/17_enter-port.png)
15. RDP port updated
   [![RDP Port Set](/assets/images/azure-vm/18_port-set.png)](/assets/images/azure-vm/18_port-set.png)
16. Set inbound networking rule
   [![Inbound Rule](/assets/images/azure-vm/19_set-inbound-rule.png)](/assets/images/azure-vm/19_set-inbound-rule.png)
...
17. Configure "My IP address" security rule
   [![My IP Rule](/assets/images/azure-vm/20_my-ip-rule.png)](/assets/images/azure-vm/20_my-ip-rule.png)
...
18. Download RDP file
   [![Download RDP File](/assets/images/azure-vm/22_download-rdp-file.png)](/assets/images/azure-vm/22_download-rdp-file.png)

## Step 4: Remote Desktop

1. Edit the downloaded RDP file.
    [![RDP config](/assets/images/azure-vm/23_remote-desktop.png)](/assets/images/azure-vm/23_remote-desktop.png)

2. Update the port.
    [![Updated RDP config](/assets/images/azure-vm/24_updated-port.png)](/assets/images/azure-vm/24_updated-port.png)

3. Start remote desktop and log into Windows.
    [![windows](/assets/images/azure-vm/25_logged-in.png)](/assets/images/azure-vm/25_logged-in.png)
